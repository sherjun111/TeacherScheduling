	...
	<body>
		...
		<div class="header">
			...
			<div class="header-right">
				...
				{{-- <livewire:admin-student-header-profile-info> --}}
					@livewire('admin-student-header-profile-info')
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="{{ route('admin.manage-subjects.cats-subcats-list') }}" class="dropdown-toggle no-arrow {{ Route::is('admin.manages-subjects.*') ? 'active' : '' }}" class="dropdown-toggle">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="{{ route('admin.manage-subjects.view-student') }}">Student</a></li>
						...
						@else
						<li>
							<a href="{{ route('student.home') }}" class="dropdown-toggle no-arrow ">
								<span class="micon fa fa-home"></span
								><span class="mtext">Home</span>
							</a>
						</li>
						...
						<li>
							<a href="{{ route('student.enroll.add-product') }}" class="dropdown-toggle no-arrow">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle {{ Route::is('student.enroll.*') ? 'active' : '' }}" class="dropdown-toggle ">
								<span class="micon fa fa-book"></span><span class="mtext">Subject View</span>
							</a>
							<ul class="submenu">
								<li><a href="{{ route('student.enroll.all-products') }}" class="{{ Route::is('student.enroll.all-products') ? 'active' : '' }}" class="">Teacher</a></li>
								<li><a href="{{ route('student.enroll.edit-product') }}" class="{{ Route::is('student.enroll.add-product') ? 'active' : '' }}" class="">Enroll</a></li>
							</ul>
						</li>
						...
						<a
								...
								class="dropdown-toggle no-arrow {{ Route::is('student.profile') ? 'active' : '' }}"
							>
								<span class="micon fa fa-user"></span>
								<span class="mtext"
									>Profile
