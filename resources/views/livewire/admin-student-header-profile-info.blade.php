					...
					<div class="dropdown">
						...
						>
							...
							<a class="dropdown-item" href="faq.html"
								><i class="dw dw-help"></i> Help</a
							>
							<a class="dropdown-item" href="{{ route('student.logout') }}" onclick="event.preventDefault();document.getElementById('studentLogoutForm').submit();"
								><i class="dw dw-logout"></i> Log Out</a
							>
							<form action="{{ route('student.logout') }}" id="studentLogoutForm" method="POST">@csrf</form>
						</div>
					</div>
				</div>
