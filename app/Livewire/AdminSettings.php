...
class AdminSettings extends Component
{
    ...
    public $site_name, $site_email, $site_phone, $site_meta_keywords,
    $site_meta_description, $site_logo, $site_favicon, $site_address;
    public $facebook_url, $github_url, $youtube_url, $twitter_url, $instagram_url,  $linkedin_url;
